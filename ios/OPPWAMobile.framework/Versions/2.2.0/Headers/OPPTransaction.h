...
/**
 ...
 @discussion The property is returned ONLY from [OPPCheckoutProvider](OPPCheckoutProvider) methods. If you are using core SDK, please [request checkout info]([OPPPaymentProvider requestCheckoutInfoWithCheckoutID:completionHandler:]) to get resource path.
 */
